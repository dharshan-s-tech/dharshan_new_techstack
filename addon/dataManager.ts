...
export const DEFAULT_CAG_PROFILE: CagProfileItem = {
  ...
  photo_url: '/assets/Images/former cag/image 1.svg',
  bio_paragraphs_en: [
    'Shri K. Sanjay Murthy assumed office as the Comptroller and Auditor General of India on 21st November, 2024.'
  ],
  bio_paragraphs_hi: [
    'श्री के. संजय मूर्ति ने 21 नवंबर, 2024 को भारत के नियंत्रक एवं महालेखापरीक्षक का पदभार ग्रहण किया।'
  ]
};
...
export const DEFAULT_VISION_MISSION: VisionMissionItem = {
  ...
  vision_desc_en: 'To be a globally recognized Supreme Audit Institution committed to excellence in public auditing and reporting.',
  vision_desc_hi: 'सार्वजनिक लेखापरीक्षा और रिपोर्टिंग में उत्कृष्टता के लिए प्रतिबद्ध विश्व स्तर पर मान्यता प्राप्त सर्वोच्च लेखापरीक्षा संस्थान बनना।',
  mission_title_en: 'Mission',
  mission_title_hi: 'ध्येय',
  mission_sub_en: 'Promoting Accountability, Transparency & Good Governance',
  mission_sub_hi: 'जवाबदेही, पारदर्शिता और सुशासन को बढ़ावा देना',
  mission_desc_en: 'To uphold accountability, transparency and good governance through independent, objective and reliable audit reports.',
  mission_desc_hi: 'स्वतंत्र, वस्तुनिष्ठ और विश्वसनीय लेखापरीक्षा रिपोर्टों के माध्यम से जवाबदेही, पारदर्शिता और सुशासन को बनाए रखना।',
  values_title_en: 'Core Values',
  values_title_hi: 'मूल मूल्य',
  values_sub_en: 'Integrity, Objectivity, Reliability, Professional Excellence',
  values_sub_hi: 'सत्यनिष्ठा, निष्पक्षता, विश्वसनीयता, पेशेवर उत्कृष्टता',
  values_desc_en: 'Professional competence, objectivity, integrity, positive approach, and confidentiality.',
  values_desc_hi: 'व्यावसायिक क्षमता, निष्पक्षता, सत्यनिष्ठा, सकारात्मक दृष्टिकोण और गोपनीयता।'
};

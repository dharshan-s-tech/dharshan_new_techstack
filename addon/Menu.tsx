  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeMega === 'presence' && (
          <div className="absolute top-[80%] left-0 pt-3 w-56 z-[1050]">
      ...
      >
        <a
          ...
          className={isAboutActive ? 'text-[#751639] !text-[#751639] underline decoration-[#751639] underline-offset-[5px] decoration-[1.5px]' : ''}

...
export default function Menu({ mobileMenuOpen, language }: { mobileMenuOpen: boolean; language?: 'English' | 'हिन्दी' }) {
  ...
  const isGlobalActive =
    decodedPath.includes('global-relations') ||
    decodedPath.includes('global relations');
  const isAboutActive =
    (decodedPath.startsWith('/about') || decodedPath.includes('about-us')) && !isGlobalActive;
  ...
  return (
    ...
    >
      ...
      {/* Our Presence */}
      <div className="nav-item">
        <Link href="/Our-Presence/Index-Menu/State-Level-Offices?filter=audit" onClick={() => setActiveMega(null)}>{labelPresence}</Link>
      </div>
      ...
      >
        <a
          ...
          className={isGlobalActive ? 'text-[#751639] !text-[#751639] underline decoration-[#751639] underline-offset-[5px] decoration-[1.5px] font-medium' : ''}
        ...
        <img
          ...
          alt=""
          className={`chevron ${isGlobalActive || activeMega === 'global' ? 'rotate-180' : ''}`}
      ...
      >
        ...
        {activeMega === 'resources' && (
          <div className="absolute top-[80%] left-0 pt-3 w-64 z-[1050]">
      ...
      >
        <a
          ...
          className={`${isAboutActive ? 'text-[#751639] !text-[#751639] underline decoration-[#751639] underline-offset-[5px] decoration-[1.5px]' : ''} hover:underline hover:decoration-double hover:decoration-[#751639] hover:underline-offset-[5px]`}
          ...
          <div className="about-menu" id="about-menu" role="menu">
            ...
            <div className="about-menu__columns">
              ...
              <div className="about-menu__column">
                ...
                <ul className="about-menu__list">
                  <li><Link href="/About/About-Us/Former-Comptroller-and-Auditors-General" onClick={() => setActiveMega(null)}>{isHindi ? 'पूर्व सीएजी' : 'Former CAGs'}</Link></li>

...
export const ADMIN_MODULES: Record<string, AdminModule> = {
  ...
  'offices': {
    ...
    columns: [
      ...
      { key: 'office_type', label: 'Department / Category' },
      { key: 'state_name', label: 'State / Region' },
      { key: 'theme', label: 'Theme' },
      { key: 'email', label: 'Email' },
      { key: 'url', label: 'Portal URL / Path' },
      { key: 'is_active', label: 'Status', type: 'boolean' },
    ],
    formFields: [
      { name: 'title', label: 'Office Name (English)', type: 'text', required: true },
      { name: 'title_hi', label: 'Office Name (Hindi)', type: 'text', isHindi: true },
      { name: 'department_id', label: 'Department / Category ID', type: 'select' },
      { name: 'state_id', label: 'State ID', type: 'select' },
      { name: 'theme', label: 'Theme Code (e.g. WDC, LDN, KUL, GSSA)', type: 'text' },
      { name: 'url', label: 'Website / Subsite URL', type: 'url' },
      { name: 'email', label: 'Email', type: 'text' },
      { name: 'is_active', label: 'Active', type: 'boolean' },
    ]
  },
  'subsites': {
    table: 'subsites',
    title: 'Subsites & Overseas Portals',
    addTitle: 'Add Subsite / Overseas Portal',
    searchColumn: 'title',
    columns: [
      { key: 'title', label: 'Office / Subsite Title' },
      { key: 'office_type', label: 'Wing / Category' },
      { key: 'state_name', label: 'State / Location' },
      { key: 'theme', label: 'Theme Code' },
      { key: 'email', label: 'Email' },
      { key: 'url', label: 'URL / Path' },
      { key: 'is_active', label: 'Status', type: 'boolean' },
    ],
    formFields: [
      { name: 'title', label: 'Office Title (English)', type: 'text', required: true },
      { name: 'title_hi', label: 'Office Title (Hindi)', type: 'text', isHindi: true },
      { name: 'department_id', label: 'Department / Wing', type: 'select' },
      { name: 'state_id', label: 'State / Jurisdiction', type: 'select' },
      { name: 'theme', label: 'Theme Code (e.g. WDC, LDN, KUL, GSSA)', type: 'text' },
      { name: 'url', label: 'Subsite URL Path', type: 'text', placeholder: '/states/overseas-london' },
  ...
  'history-of-indian-audit-and-accounts-department': {
    table: 'pages',
    title: 'History of IAAD Volumes & Chapters',
    addTitle: 'Add Historical Volume / Chapter',
    searchColumn: 'title_en',
    columns: [
      { key: 'title_en', label: 'Title (English)' },
      { key: 'title_hi', label: 'Title (Hindi)' },
      { key: 'primary_key_or_slug', label: 'Volume / Part' },
      { key: 'file_name', label: 'Attachment (PDF)', type: 'link' },
      { key: 'is_active', label: 'Status', type: 'boolean' },
    ],
    formFields: [
      { name: 'title_en', label: 'Title / Chapter (English)', type: 'text', required: true },
      { name: 'title_hi', label: 'Title / Chapter (Hindi)', type: 'text', isHindi: true },
      { name: 'primary_key_or_slug', label: 'Volume / Section Reference', type: 'text', required: true },
      { name: 'desc', label: 'Historical Description', type: 'textarea' },
      { name: 'file_url', label: 'Document Link (URL)', type: 'url' },
      { name: 'upload_file', label: 'Upload PDF Document', type: 'file' },
      { name: 'is_active', label: 'Active', type: 'boolean' },
    ]
  },

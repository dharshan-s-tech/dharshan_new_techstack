...
export const mainNavigation: MenuItem[] = [
  {
    ...
    slug: 'about',
    subcategories: [
      { name: 'CAG of India', slug: 'cag-profile' },
      { name: 'Our Vision, Mission and Core Values', slug: 'vision-mission' },
      { name: 'Organization Chart', slug: 'organisation-chart' },
      { name: 'History of IAAD', slug: 'history' },
      { name: 'Former CAGs', slug: 'former-cags' },

    ...
    <div className="space-y-6 text-xs text-zinc-700">
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-xs overflow-hidden mb-12">
        <div className="px-5 py-4 border-b border-zinc-100 flex justify-between items-center">
          <div>
            <h3 className="font-bold text-zinc-800 text-[16px]">Circulars</h3>
            <p className="text-[12px] text-zinc-500 mt-0.5">
              Displaying {circulars.length === 0 ? 0 : 1}–{circulars.length} of {circulars.length}.
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#f7f8fa] border-b border-zinc-100 text-left">
                ...
                <th className="px-4 py-3 text-[11px] font-bold uppercase tracking-wide text-zinc-500 w-44">Circular No</th>
                <th className="px-4 py-3 text-[11px] font-bold uppercase tracking-wide text-zinc-500">Title</th>
                <th className="px-4 py-3 text-[11px] font-bold uppercase tracking-wide text-zinc-500 w-36">Issue Date</th>
              ...
              {loading ? (
                ...
                circulars.map((item, idx) => (
                  <tr key={item.id} className="hover:bg-zinc-50/50 transition-colors text-zinc-800">
                    ...
                    <td className="px-4 py-3 font-mono text-zinc-700 font-bold">{item.circular_no || '-'}</td>
                    <td className="px-4 py-3 font-bold text-[#751639] max-w-md">{item.title_en}</td>
                    <td className="px-4 py-3 font-mono text-zinc-600">{item.issue_date || '-'}</td>

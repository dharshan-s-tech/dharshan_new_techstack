...
const INITIAL_ABOUT_RECORDS: AboutRecord[] = [
  ...
  },
  {
    ...
    formattedId: '#AB-002',
    category: 'Who We Are',
    subTopic: 'Our Vision, Mission and Core Values',
...
function AdminAboutRegistryContent() {
  ...
  const subTopics = [
    { label: 'CAG of India', value: 'cag-of-india' },
    { label: 'Our Vision, Mission and Core Values', value: 'our-vision-mission-values' },
    { label: 'Organization Chart', value: 'organisation-chart' },
    { label: 'Former CAGs', value: 'former-cags' },

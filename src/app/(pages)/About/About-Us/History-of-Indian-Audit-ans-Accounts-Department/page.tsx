              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    {/* Circle icon 32px with #751639 background matching Figma Ellipse 783 */}
                    <div className="w-[32px] h-[32px] rounded-full bg-[#751639] flex items-center justify-center text-white flex-shrink-0 shadow-xs">
                      {section.iconType === 'analytical' ? (
                        <FigmaAnalyticalHistoryIcon />
                      ) : (
                        <FigmaThematicHistoryIcon />
                      )}
                    </div>
